  ...
  <div class="box">
    ...
    <div class="content">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        ...
        <table class="form">
          <tr>
            <td style="width: 300px;"><span class="required">*</span> <?php echo $entry_name; ?></td>
        ...
        <table class="form">
          <tr>
            <td style="width: 300px;"><?php echo $entry_approval; ?></td>
            <td><?php if ($approval) { ?>
        ...
        <table class="form">
		  <tr>
            <td style="width: 300px;"><?php echo $entry_address_display; ?></td>
            <td><?php if ($address_display) { ?>
        ...
        <table class="form">
		  <tr>
            <td style="width: 300px;"><?php echo $entry_additional_display; ?></td>
            <td><?php if ($additional_display) { ?>
        ...
        <table class="form">
          <tr>
            <td style="width: 300px;"><?php echo $entry_sort_order; ?></td>
