...
<div class="box">
  ...
  <div class="content">
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
      <table class="form">
		<tr>
          <td><?php echo $fiter_view_style; ?></td>
          <td><select name="filter_style">
              <?php foreach ($fiter_view_styles as $fiter_view_style) { ?>
              <?php if ($filter_style == $fiter_view_style['fiter_view_style']) { ?>
              <option value="<?php echo $fiter_view_style['fiter_view_style']; ?>" selected="selected"><?php echo $fiter_view_style['title']; ?></option>
              <?php } else { ?>
              <option value="<?php echo $fiter_view_style['fiter_view_style']; ?>"><?php echo $fiter_view_style['title']; ?></option>
              <?php } ?>
              <?php } ?>
            </select></td>
        </tr>
