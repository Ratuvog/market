...
class ControllerFeedArticlesGoogleSitemap extends Controller {
	...
	public function index() {
		$this->load->language('feed/articles_google_sitemap');
		...
		$this->data['action'] = $this->url->link('feed/articles_google_sitemap', 'token=' . $this->session->data['token'], 'SSL');
		...
		if (isset($this->request->post['articles_google_sitemap_status'])) {
			$this->data['articles_google_sitemap_status'] = $this->request->post['articles_google_sitemap_status'];
		} else {
			$this->data['articles_google_sitemap_status'] = $this->config->get('articles_google_sitemap_status');
		}
		
		$this->data['data_feed'] = HTTP_CATALOG . 'index.php?route=feed/articles_google_sitemap';

		$this->template = 'feed/articles_google_sitemap.tpl';
		$this->children = array(
			'common/header',
			'common/footer'
		);
