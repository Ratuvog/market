...
// Entry
$_['entry_url']                = 'URL магазина:<br /><span class="help">Включая полный URL к магазину. Добавьте \'/\' в конце. Например: http://wwww.yourdomain.ru/path/</span>';
$_['entry_ssl']                = 'SSL URL:<br /><span class="help">SSL ссылка к магазину. Убедитесь, что \'/\' стоит в конце. Например: http://www.yourdomain.ru/path/<br /><br />Не используйте директории для создания нового магазина. Необходимо использовать поддомен или новый домен.</span>';
...
$_['entry_customer_group_display'] = 'Группы покупателей:<br /><span class="help">Укажите группы покупателей, которые будут показаны покупателю при регистрации в магазине и он сам сможет выбрать для себя более подходящую.</span>';
