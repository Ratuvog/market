...
$_['entry_type_menu']          		= 'Type of menu categories:<br /><span class="help">Specify the type of the upper horizontal menu categories.</span>';
$_['entry_catalog_limit'] 	   		= 'Catalog:<br /><span class="help">Determines how many catalog items are shown per page (products, categories, etc)</span>';
$_['entry_admin_limit']   	   		= 'Administration:<br /><span class="help">Determines how many admin items are shown per page (orders, customers, etc)</span>';
...
$_['entry_sms_gatename']       		= 'SMS gateway:<br/><span class="help">Service for sending SMS<br/>Example <a target="_blank" href="http://avisosms.ru?refer=3502">avisosms</a></span>';
$_['entry_sms_to']             		= 'Telephone administrator:<br/><span class="help">Формат: 7926xxxxxxx</span>';
$_['entry_sms_from']           		= 'The alias of the sender:<br/><span class="help">Example: Domenam.ru</span>';
$_['entry_sms_message']        		= 'Text of message:<br/><span class="help">You can use the tags:<br/>{ID} - order number<br/>{DATE},{TIME} - date and time of the formation of the order<br/>{SUM} - the amount of the order</span>';
...
$_['entry_sms_copy']           		= 'Additional numbers:<br/><span class="help">Additional phone numbers of recipients of SMS</span>';
$_['entry_seo_url_type']       		= 'Type SEO URLs:';
$_['entry_seo_url_include_path'] 	= 'SEO URLs goods to the categories:<span class="help">/category/subcategory/product<br />(only for SeoPro)</span>';
$_['entry_seo_url_postfix']    		= 'End of the SEO URLs:<span class="help">Example .html<br />(only for SeoPro)</span>';
$_['entry_registred_group']    		= 'The group registered:<br /><span class="help">Shall be appointed by the registration.</span>';
