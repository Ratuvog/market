<?php echo $header; ?>
<h1 style="background: url('view/image/finished.png') no-repeat;">Обновление выполнено!</h1>
<div style="width: 100%; display: inline-block;">
  <div style="float: left; width: 569px;">
    <div class="warning">Не забудьте удалить каталог установки!</div>
    <p>Поздравляем! Вы успешно скрипт магазина на сборку MaxyStore v.1.5.3.1.</p>
    <div style="text-align: center; float: left; margin-bottom: 15px;"><a href="../"><img src="view/image/screenshot_1.png" alt="" width="270" style="border: 1px solid #DDDDDD; padding: 2px; margin-bottom: 3px;" /></a><br />
      <a href="../">Перейти к витрине магазина</a>
    </div>
